...
save("mca", file=here("00_data_ingest", "sanne_analysis", "wells_han_data"))

```
```{r}

unique(grep(pattern="*Fetal_Kidney*", x=unique(mca@meta.data$Annotation), value = TRUE))
...
grep(pattern="*[Ee]ndot*", x=unique(mca@meta.data$Annotation), value = TRUE)
grep(pattern="*[Ee]pit*", x=unique(mca@meta.data$Annotation), value = TRUE)


```
```{r}

sink(here("00_data_ingest", "sanne_analysis", "wells_han_cells"))
...
```{r}
#|Lung|Intestine|Kidney|Bladder|Liver
cat(grep(pattern="Heart", x=unique(mca@meta.data$Annotation), value = TRUE), sep="\n")
cat(grep(pattern="Lung", x=unique(mca@meta.data$Annotation), value = TRUE), sep="\n")
cat(grep(pattern="Intestine", x=unique(mca@meta.data$Annotation), value = TRUE), sep="\n")
cat(grep(pattern="Kidney", x=unique(mca@meta.data$Annotation), value = TRUE), sep="\n")
cat(grep(pattern="Bladder", x=unique(mca@meta.data$Annotation), value = TRUE), sep="\n")
cat(grep(pattern="Liver", x=unique(mca@meta.data$Annotation), value = TRUE), sep="\n")
cat(grep(pattern="Brain", x=unique(mca@meta.data$Annotation), value = TRUE), sep="\n")
