...
facsBladderCells = c(facsBladderEndo,facsBladderEpi, facsBladderEpi)
facsLiverCells = c(facsLiverEndo, facsLiverEpi, facsLiverEpi)
...
VlnPlot(object = facsTiss, features = rownames(head(x = lung_endo_rest_markers_facs, n=2)), ncol=2, idents=unique(c(facsAllLung, facsLungEpi, facsLungEndo)), slot = 'counts', log = TRUE, same.y.lims =FALSE)
...
a=makeNewAnalysisFacs(facsKidneyEndo, c(facsLungEndo, facsAortaEndo, facsBladderEndo, facsLiverEndo), "kidney", "endo_excl_")
a=makeNewAnalysisFacs(facsLungEndo, c(facsKidneyEndo, facsAortaEndo, facsBladderEndo, facsLiverEndo), "lung", "endo_excl_")
a=makeNewAnalysisFacs(facsAortaEndo, c(facsLungEndo, facsKidneyEndo, facsBladderEndo, facsLiverEndo), "aorta", "endo_excl_")
a=makeNewAnalysisFacs(facsBladderEndo, c(facsAortaEndo, facsLungEndo, facsKidneyEndo, facsLiverEndo), "bladder", "endo_excl_")
a=makeNewAnalysisFacs(facsLiverEndo, c(facsAortaEndo, facsLungEndo, facsKidneyEndo, facsBladderEndo), "liver", "endo_excl_")
...
```{r results="hide", echo=FALSE}
a=makeNewAnalysisFacs(facsKidneyEndo, c(facsKidneyCir, facsLungCir, facsAortaCir, facsBladderCir, facsLiverCir), "kidney", "endo_cir_excl_")
a=makeNewAnalysisFacs(facsLungEndo, c(facsLungCir, facsKidneyCir, facsAortaCir, facsBladderCir, facsLiverCir), "lung", "endo_cir_excl_")
a=makeNewAnalysisFacs(facsAortaEndo, c(facsAortaCir, facsLungCir, facsKidneyCir, facsBladderCir, facsLiverCir), "aorta", "endo_cir_excl_")
a=makeNewAnalysisFacs(facsBladderEndo, c(facsBladderCir, facsAortaCir, facsLungCir, facsKidneyCir, facsLiverCir), "bladder", "endo_cir_excl_")
a=makeNewAnalysisFacs(facsLiverEndo, c(facsLiverCir, facsAortaCir, facsLungCir, facsKidneyCir, facsBladderCir), "liver", "endo_cir_excl_")
```

## AGAINST ALL OTHER EPITHELIAL

```{r results="hide", echo=FALSE}
a=makeNewAnalysisFacs(facsKidneyEndo, c(facsKidneyEpi, facsLungEpi, facsAortaEpi, facsBladderEpi, facsLiverEpi), "kidney", "endo_epi_excl_")
a=makeNewAnalysisFacs(facsLungEndo, c(facsLungEpi, facsKidneyEpi, facsAortaEpi, facsBladderEpi, facsLiverEpi), "lung", "endo_epi_excl_")
a=makeNewAnalysisFacs(facsAortaEndo, c(facsAortaEpi, facsLungEpi, facsKidneyEpi, facsBladderEpi, facsLiverEpi), "aorta", "endo_epi_excl_")
a=makeNewAnalysisFacs(facsBladderEndo, c(facsBladderEpi, facsAortaEpi, facsLungEpi, facsKidneyEpi, facsLiverEpi), "bladder", "endo_epi_excl_")
a=makeNewAnalysisFacs(facsLiverEndo, c(facsLiverEpi, facsAortaEpi, facsLungEpi, facsKidneyEpi, facsBladderEpi), "liver", "endo_epi_excl_")
```
...
a=makeNewAnalysisFacs(facsKidneyEndo, c(facsKidneyEpi, facsLungEpi, facsAortaEpi, facsBladderEpi, facsLiverEpi,facsKidneyCir, facsLungCir, facsAortaCir, facsBladderCir, facsLiverCir), "kidney", "endo_cirepi_excl_")
a=makeNewAnalysisFacs(facsLungEndo, c(facsKidneyEpi, facsLungEpi, facsAortaEpi, facsBladderEpi, facsLiverEpi,facsLungCir, facsKidneyCir, facsAortaCir, facsBladderCir, facsLiverCir), "lung", "endo_cirepi_excl_")
a=makeNewAnalysisFacs(facsAortaEndo, c(facsKidneyEpi, facsLungEpi, facsAortaEpi, facsBladderEpi, facsLiverEpi,facsAortaCir, facsLungCir, facsKidneyCir, facsBladderCir, facsLiverCir), "aorta", "endo_cirepi_excl_")
a=makeNewAnalysisFacs(facsBladderEndo, c(facsKidneyEpi, facsLungEpi, facsAortaEpi, facsBladderEpi, facsLiverEpi,facsBladderCir, facsAortaCir, facsLungCir, facsKidneyCir, facsLiverCir), "bladder", "endo_cirepi_excl_")
a=makeNewAnalysisFacs(facsLiverEndo, c(facsKidneyEpi, facsLungEpi, facsAortaEpi, facsBladderEpi, facsLiverEpi,facsLiverCir, facsAortaCir, facsLungCir, facsKidneyCir, facsBladderCir), "liver", "endo_cirepi_excl_")
```
