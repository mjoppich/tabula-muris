...
facsAllAorta = unique(grep(pattern="Aorta", x=facsTiss@meta.data$Annotation, value = TRUE))
...
facsAllLint = unique(grep(pattern="Large_Intestine", x=facsTiss@meta.data$Annotation, value = TRUE))
